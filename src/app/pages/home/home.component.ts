  ...
  template: `
    ...
    >
      ...
      <p class="text-center text-lg text-black-800 mb-6 font-semibold">
        🛍️ Shop the best products at unbeatable prices!
      </p>
      <button
        (click)="onShopNow()"
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-red-200 p-4 rounded-lg shadow-md">
          ...
          <p class="mt-4 font-bold">
            <br />Hurry, these offers are valid for a limited time only!
          </p>
          <!-- <button
    ...
    >
      View All Offers
        ...
        <div class="bg-green-200 p-4 rounded-lg shadow-md">
          ...
          <ul class="mt-2">
            <li>
              ✔ Smartwatch: Stay connected with our new smartwatch collection
            </li>
            <li>✔ Summer Fashion: Explore our vibrant summer clothing line</li>
            <li>
              ✔ Home Decor: Freshen up your space with our new decor items
            </li>
            <li>✔ Fitness Gear: Get fit with our latest workout equipment</li>
          </ul>
          <p class="mt-4 font-bold">
            <br />Be the first to grab these exciting new products!
          </p>
          <!-- <button
      class="mt-2 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700"
      routerLink="newarr"
      ...
      Shop New Arrivals
        ...
        <div class="bg-yellow-200 p-4 rounded-lg shadow-md">
          ...
          <ul class="mt-2">
            ...
            <li>
              ✔ Skincare Essentials: Pamper yourself with our best-selling
              products
            </li>
          </ul>
          <p class="mt-4 font-bold">
            <br />Join the trend and see what everyone is raving about!
          </p>
          <!-- <button
      class="mt-2 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700"
      routerLink=""
    ...
    View our Products
      ...
      >
        ...
        <p class="text-black-700 text-lg italic">
          "Great service and quality! I was pleasantly surprised by how quickly
          my order arrived, and the products exceeded my expectations."
        </p>
        ...
        <p class="text-black-700 text-lg italic mt-4">
          ...
          the attention to detail in packaging. Will definitely shop here
          again!"
        </p>
